...
<html>
	...
	<body>
		<form action="selectPlaServlet" method="post" id="top">
			检索队员：
			<input type="text" class="form-control" id="Playername" placeholder="请输入名字" name="ss" />
			<input type="submit" class="btn btn-warning" />
		</form>
		
		<%Player pla = (Player)request.getAttribute("pla");%>
