...
/**
 * Servlet implementation class SelectMatServlet
 */
@WebServlet("/SelectMatServlet")
public class SelectMatServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectMatServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Match> matlist = matservice.mhcx(ss);
