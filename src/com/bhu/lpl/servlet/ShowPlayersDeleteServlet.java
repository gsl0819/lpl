...
/**
 * Servlet implementation class ShowPlayersDeleteServlet
 */
@WebServlet("/ShowPlayersDeleteServlet")
public class ShowPlayersDeleteServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowPlayersDeleteServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(Playerid!=null && Playerid!=""){
			...
			request.getRequestDispatcher("deleteplas.jsp").forward(request, response);
		}
	}
